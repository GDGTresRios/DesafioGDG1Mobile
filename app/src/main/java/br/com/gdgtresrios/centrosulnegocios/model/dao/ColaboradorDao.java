...
public class ColaboradorDao {
    ...
    public List<Colaborador> listByNomeCategoria(CategoriaColaborador categoriaColaborador, String nome) {
        List<Colaborador> colaboradorList = new ArrayList<>();
        Cursor cursor = database.query(TABLE_NAME, new String[]{COLUMN_ID, COLUMN_NOME, COLUMN_DESCRICAO, COLUMN_LOGO,
                        COLUMN_DESCRICAO_DETALHADA, COLUMN_ENDERECO_VIRTUAL, COLUMN_EMAIL, COLUMN_TELEFONE, COLUMN_ENDERECO,
                        COLUMN_PATROCINADOR, COLUMN_PALESTRANTE, COLUMN_EXPOSITOR, COLUMN_FK_CATEGORIA_COLABORADOR},
                COLUMN_NOME + " LIKE ? AND " + COLUMN_FK_CATEGORIA_COLABORADOR + " = ? ",
                new String[]{"%"+nome+"%", String.valueOf(categoriaColaborador.getId())}, null, null, null);
    ...
    public List<Colaborador> listAll() {
        ...
        Cursor cursor = database.query(TABLE_NAME, new String[]{COLUMN_ID, COLUMN_NOME, COLUMN_DESCRICAO, COLUMN_LOGO,
                        COLUMN_DESCRICAO_DETALHADA, COLUMN_ENDERECO_VIRTUAL, COLUMN_EMAIL, COLUMN_TELEFONE, COLUMN_ENDERECO,
                        COLUMN_PATROCINADOR, COLUMN_PALESTRANTE, COLUMN_EXPOSITOR, COLUMN_FK_CATEGORIA_COLABORADOR}, null, null, null, null, null);
